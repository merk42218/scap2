class UsersRolesController < ApplicationController
  ...
  def index
    authorize! :index,   @users_roles = UsersRole.all
  end

  # GET /users_roles/1
  # GET /users_roles/1.json
  def show
    authorize! :show, @user_roles
  end

  # GET /users_roles/new
  def new
    authorize! :create,  @users_role = UsersRole.new
  end

  # GET /users_roles/1/edit
  def edit
    authorize! :edit, @users_role
  end
